...
class Profile extends React.Component {
  componentDidMount() {
    ...
    this.props.fetchUserStats(this.props.currentUser.id);
    this.props.fetchUserDailyStats(this.props.currentUser.id);
  }
  ...
  render() {
    ...
    if (!this.props.stats.user[0] || !this.props.stats.userDaily[0] ) {
      ...
      let right = this.props.stats.user[0].Correct;
      let wrong = this.props.stats.user[0].Total - right;
      lineData = this.props.stats.userDaily.map( data => {
        return {
          name: data.name,
          amt: data.amt,
          Score: data.Score
      ...
      barData = this.props.stats.userDaily.map( data => {
        return {
          name: data.name,
          amt: data.amt,
          right: data.Right,
          ...
          <div className="container-list-row-start-start">
            <div className="container-2-col">
              ...
              <div className="chart-container-offset">
                <h3>Daily Rank</h3>
                <ResponsiveContainer>
                  <LineChart data={lineData} margin={{ top: 15, right: 50, left: 20, bottom: 5 }}>
